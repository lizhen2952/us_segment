...
def input_images(x, y, i, n_iter, k=1):
    ...
    if k == 1:
        ...
        ax1.set_yticklabels([])
        plt.savefig(
            r'E:\LZ\Unet-Segmentation-Pytorch-Nest-of-Unets-master\model\pred\L_' + str(n_iter-1) + '_epoch_'
            + str(i))
...
def plot_kernels(tensor, n_iter, num_cols=5, cmap="gray"):
    ...
    plt.savefig(
        r'E:\LZ\Unet-Segmentation-Pytorch-Nest-of-Unets-master\model\pred\Kernal_' + str(n_iter - 1) + '_epoch_'
        + str(i))
...
def plot_grad_flow(named_parameters,n_iter):
    ...
    #plt.savefig('r'E:\LZ\Unet-Segmentation-Pytorch-Nest-of-Unets-master\model\pred\Grad_Flow_' + str(n_iter - 1))
