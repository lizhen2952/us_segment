...
from Metrics import dice_coeff, accuracy_score,iou,threshold_By_OTSU
import time
...
if __name__ == '__main__':
    t_data = r'E:\LZ\public_data\EchoNet-Dynamic\save\echonet\segmentation\imgs\train'
    l_data = r'E:\LZ\public_data\EchoNet-Dynamic\save\echonet\segmentation\masks\train'
    test_image = r'E:\LZ\public_data\EchoNet-Dynamic\save\echonet\segmentation\imgs\val\0X1B48047F9A40121_81_0.png'
    test_label = r'E:\LZ\public_data\EchoNet-Dynamic\save\echonet\segmentation\masks\val\0X1B48047F9A40121_81_0.png'
    test_folderP = r'E:\LZ\public_data\EchoNet-Dynamic\save\echonet\segmentation\imgs\test\*'
    test_folderL = r'E:\LZ\public_data\EchoNet-Dynamic\save\echonet\segmentation\masks\test\*'
    ...
    #######################################################
    num=0
    for i in model_test.parameters():
        if i.requires_grad==True:
            num+=i.numel()
    # torchsummary.summary(model_test, input_size=(3, 128, 128),batch_size=batch_size)
    print('Total number of trainable parameters = ' + str(num))
    #######################################################
    ...
    New_folder = r'E:\LZ\Unet-Segmentation-Pytorch-Nest-of-Unets-master\model'
    ...
    read_pred = r'E:\LZ\Unet-Segmentation-Pytorch-Nest-of-Unets-master\model\pred'
    ...
    read_model_path = r'E:\LZ\Unet-Segmentation-Pytorch-Nest-of-Unets-master\model\Unet_D_' + \
    ...
    #pred_tb = threshold_predictions_v(pred_tb)
        ...
        x1 = plt.imsave(
            r'E:\LZ\Unet-Segmentation-Pytorch-Nest-of-Unets-master\model\pred\img_iteration_' +
            str(n_iter) + '_epoch_'
    ...
    #      writer1.add_scalar('Validation Loss', valid_loss, n_iter)
        ...
        if valid_loss <= valid_loss_min and epoch_valid >= i:  # and i_valid <= 2:
            ...
            torch.save(model_test.state_dict(), r'E:\LZ\Unet-Segmentation-Pytorch-Nest-of-Unets-master\model\Unet_D_' +
                       str(epoch) + '_' + str(batch_size) +
                       r'\Unet_epoch_' + str(epoch)
    ...
    test1 = model_test.load_state_dict(torch.load(r'E:\LZ\Unet-Segmentation-Pytorch-Nest-of-Unets-master\model\Unet_D_' +
                                                  str(epoch) + '_' + str(batch_size) +
                                                  r'\Unet_epoch_' + str(epoch)
                                                  + '_batchsize_' + str(batch_size) + '.pth'))
    ...
    model_test.load_state_dict(torch.load(r'E:\LZ\Unet-Segmentation-Pytorch-Nest-of-Unets-master\model\Unet_D_' +
                                          str(epoch) + '_' + str(batch_size) +
                                          r'\Unet_epoch_' + str(epoch)
                                          + '_batchsize_' + str(batch_size) + '.pth'))
    ...
    read_test_folder112 = r'E:\LZ\Unet-Segmentation-Pytorch-Nest-of-Unets-master\model\gen_images'
    ...
    try:
        ...
        print("Creation of the testing directory %s failed" %
              read_test_folder112)
    else:
        print("Successfully created the testing directory %s " %
              read_test_folder112)

    # For Prediction Threshold

    read_test_folder_P_Thres = r'E:\LZ\Unet-Segmentation-Pytorch-Nest-of-Unets-master\model\pred_threshold'
    ...
    read_test_folder_L_Thres = r'E:\LZ\Unet-Segmentation-Pytorch-Nest-of-Unets-master\model\label_threshold'
    ...
    #    pred = threshold_predictions_p(pred) #Value kept 0.01 as max is 1 and noise is very small.
        ...
        x1 = plt.imsave(r'E:\LZ\Unet-Segmentation-Pytorch-Nest-of-Unets-master\model\gen_images\im_epoch_' + str(epoch) + 'int_' + str(i)
    ...
    for i in range(len(read_test_folderP)):
        ...
        # save the images
        x1 = plt.imsave(r'E:\LZ\Unet-Segmentation-Pytorch-Nest-of-Unets-master\model\pred_threshold\im_epoch_' + str(epoch) + 'int_' + str(i)
    ...
    # s2 =threshold_predictions_v(s2)
        ...
        # save the Images
        y1 = plt.imsave(r'E:\LZ\Unet-Segmentation-Pytorch-Nest-of-Unets-master\model\label_threshold\im_epoch_' + str(epoch) + 'int_' + str(i)
                        + '_img_no_' + str(img_test_no) + '.png', s3)

        iou_score = iou(s, s3)
        iou_total = iou_score + iou_total
    ...
    print("iou_score: ", iou_total/len(read_test_folderP))
